...
$node_(0) set X_ 465.0;
$node_(0) set Y_ 800.0;
$node_(0) set Z_ 0.0;

$node_(1) set X_ 685.0;
...
$node_(6) set X_ 685.0;
$node_(6) set Y_ 200.0;
$node_(6) set Z_ 0.0;

$node_(5) set X_ 465.0;
...
$ns at 0.0 "$node_(0) setdest 465.0 800.0 0.0";
$ns at 0.0 "$node_(1) setdest 685.0 800.0 0.0";
$ns at 0.0 "$node_(2) setdest 575.0 500.0 0.0";
$ns at 0.0 "$node_(6) setdest 685.0 200.0 0.0";
$ns at 0.0 "$node_(5) setdest 465.0 200.0 0.0";
